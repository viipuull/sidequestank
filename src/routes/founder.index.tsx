        ...
        {data && (
          <>
            <section className="mt-6 grid grid-cols-2 gap-3">
              ...
              <Link
                to="/founder/achievements"
                className="col-span-2 flex items-center justify-between rounded-2xl border border-fuchsia-400/40 bg-fuchsia-500/10 p-4 shadow-md transition active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  <div className="grid h-10 w-10 place-items-center rounded-xl bg-fuchsia-500/20 text-fuchsia-300">
                    <Sparkles className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-widest text-fuchsia-300">Achievements Manager</p>
                    <p className="text-sm font-semibold text-foreground">Design, edit & assign badges</p>
                  </div>
                </div>
              ...
              <Link
                to="/founder/social"
                className="col-span-2 flex items-center justify-between rounded-2xl border border-emerald-400/40 bg-emerald-500/10 p-4 shadow-md transition active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest text-emerald-300">Social Manager</p>
                    <p className="text-sm font-semibold text-foreground">Feature players, seasons & moderation</p>
                  </div>
                </div>
              ...
              <Link
                to="/founder/liveops"
                className="col-span-2 flex items-center justify-between rounded-2xl border border-rose-400/40 bg-rose-500/10 p-4 shadow-md transition active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest text-rose-300">LiveOps Manager</p>
                    <p className="text-sm font-semibold text-foreground">Events, challenges & announcements</p>
                  </div>
                </div>
